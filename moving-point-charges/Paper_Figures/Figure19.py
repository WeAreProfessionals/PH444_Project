...
charges = (OscillatingOrbittingCharge(pos_charge=True, max_speed=0.5*c),)
t = 0
...
# %% Animation
charges = (OscillatingOrbittingCharge(pos_charge=True, start_zero=True,
                           max_speed=0.5*c),)
field = MovingChargesField(charges)
...
ani = FuncAnimation(fig, _update_animation, interval=1000/12,
                    frames=120, blit=False, init_func=_init_animate)
